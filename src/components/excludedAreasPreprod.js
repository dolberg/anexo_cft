...
var exclusiones = L.tileLayer.wms(urlWMS, {
  layers: 'SDP-preprod:exclusion_areas',
  format: 'image/png',
  opacity: 1,
  tyles: '',
  transparent: true,
...
var ordenamientoBosquesNativos = L.tileLayer.wms(urlWMS, {
  layers: 'SDP-preprod:all_the_territory',
  format: 'image/png',
  opacity: 1,
  tyles: '',
  transparent: true,
...
var zonasProtegidas = L.tileLayer.wms(urlWMS, {
  layers: ['SDP-preprod:wdpa0','SDP-preprod:wdpa1','SDP-preprod:wdpa1','SDP-preprod:iucn0','SDP-preprod:iucn1','SDP-preprod:iucn2'],
  format: 'image/png',
  opacity: 1,
  tyles: '',
  transparent: true,
...
var sitiosRamsar = L.tileLayer.wms(urlWMS, {
  layers: 'SDP-preprod:ramsar_worldwide',
  format: 'image/png',
  opacity: 1,
  tyles: '',
  transparent: true,
...
var aves = L.tileLayer.wms(urlWMS, {
  layers: ['SDP-preprod:aicas', 'SDP-preprod:aicas_brasil', 'SDP-preprod:aicas_paraguay', 'SDP-preprod:ibas_uruguay'],
  format: 'image/png',
  opacity: 1,
  tyles: '',
  transparent: true,
...
function genPoli(){
  ...
  if (n==0){
    editableLayers.toGeoJSON().features.forEach(function(feat){
      ...
      http.open('POST', 'https://sdp.herokuapp.com/excluded_areas_preprod', true);
